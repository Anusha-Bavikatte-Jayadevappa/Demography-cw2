...
function createHeaderStatsVisualization(
  ...
  Promise.all([headerStats(country_code, year)]).then(function (data) {
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[0] + "_%_change_in_last_1_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[0] + "_%_change_in_last_1_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[0] + "_%_change_in_last_10_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[0] + "_%_change_in_last_10_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[1] + "_%_change_in_last_1_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[1] + "_%_change_in_last_1_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[1] + "_%_change_in_last_10_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[1] + "_%_change_in_last_10_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[2] + "_%_change_in_last_1_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[2] + "_%_change_in_last_1_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
    ...
    svg
      ...
      .attr("class", "value")
      .style("fill", function () {
        if (data[0][property_list[2] + "_%_change_in_last_10_year"] > 0) {
          return "green";
        } else {
          return "red";
        }
      ...
      .tween("value", function (d, i) {
        d = parseFloat(
          data[0][property_list[2] + "_%_change_in_last_10_year"].toFixed(2)
        );
        var i = d3.interpolate(this.textContent, d),
          prec = (d + "").split("."),
          round = prec.length > 1 ? Math.pow(10, prec[1].length) : 1;
...
function createMapLayout(
  ...
  var colorScale = d3.scaleLinear().range(["#722F37", "#280001"]);
...
function createGroupedScatterPlot(
  ...
  combinedPropertyStatsPerYearWithMetadataLookup(year).then(function (data) {
    ...
    const color = d3
      ...
      .range(["#ffcacf", "#c5797f", "#571722", "#280001"]);
