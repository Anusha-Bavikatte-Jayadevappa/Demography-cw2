  ...
  final_data = d3.csv(csv_loc).then(function (data) {
    var property_data = data.map(function (d) {
      ...
      if (d["IncomeGroup"] == "Upper middle income") {
        income_grp_key = "Upper-middle";
      }
      if (d["IncomeGroup"] == "Lower middle income") {
        income_grp_key = "Lower-middle";
      }
...
function headerStats(country_code, year) {
  ...
  final_data = Promise.all([
    ...
    combinedPropertyStatsPerYearPerCountry(year_minus_1, country_code),
    combinedPropertyStatsPerYearPerCountry(year_minus_10, country_code),
  ]).then(function (loadData) {
    property_currentyear_data = loadData[0];
    property_year_minus_1_data = loadData[1];
    property_year_minus_10_data = loadData[2];
    ...
    //Get 1 year back stats
    var property_1_T1 = property_list[0] + "_" + year_minus_1;
    var property_2_T1 = property_list[1] + "_" + year_minus_1;
    var property_3_T1 = property_list[2] + "_" + year_minus_1;
    jsonData[property_1_T1] = property_year_minus_1_data[property_list[0]];
    jsonData[property_2_T1] = property_year_minus_1_data[property_list[1]];
    jsonData[property_3_T1] = property_year_minus_1_data[property_list[2]];

    //Get 10 years back stats
    var property_1_T10 = property_list[0] + "_" + year_minus_10;
    var property_2_T10 = property_list[1] + "_" + year_minus_10;
    var property_3_T10 = property_list[2] + "_" + year_minus_10;
    jsonData[property_1_T10] = property_year_minus_10_data[property_list[0]];
    jsonData[property_2_T10] = property_year_minus_10_data[property_list[1]];
    jsonData[property_3_T10] = property_year_minus_10_data[property_list[2]];
    ...
    jsonDataFinal["population_%_change_in_last_1_year"] =
      ((jsonData[property_1_T0] - jsonData[property_1_T1]) /
        jsonData[property_1_T1]) *
      100;
    jsonDataFinal["population_%_change_in_last_10_year"] =
      ((jsonData[property_1_T0] - jsonData[property_1_T10]) /
        jsonData[property_1_T10]) *
      100;

    jsonDataFinal["current_fertility_rate"] = jsonData[property_2_T0];
    jsonDataFinal["fertility_rate_%_change_in_last_1_year"] =
      ((jsonData[property_2_T0] - jsonData[property_2_T1]) /
        jsonData[property_2_T1]) *
      100;
    jsonDataFinal["fertility_rate_%_change_in_last_10_year"] =
      ((jsonData[property_2_T0] - jsonData[property_2_T10]) /
        jsonData[property_2_T10]) *
      100;

    jsonDataFinal["current_life_expectancy"] = jsonData[property_3_T0];
    jsonDataFinal["life_expectancy_%_change_in_last_1_year"] =
      ((jsonData[property_3_T0] - jsonData[property_3_T1]) /
        jsonData[property_3_T1]) *
      100;
    jsonDataFinal["life_expectancy_%_change_in_last_10_year"] =
      ((jsonData[property_3_T0] - jsonData[property_3_T10]) /
        jsonData[property_3_T10]) *
      100;
